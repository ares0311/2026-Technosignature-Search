...
| `data/extended_corpus/` | `scripts/download_bl_extended_corpus.sh` | Held-out GBT `.dat` evidence stream for DECISION-134 hardening | Ignored payloads; commit review-safe manifests only |
...
1. Extended GBT corpus: `data/extended_corpus/<target>/*.dat`
