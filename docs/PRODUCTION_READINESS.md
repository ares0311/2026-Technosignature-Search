...
| N₂O (agricultural enhancement) detection | ❌ Not started — N₂O's real diagnostic bands are mid-infrared (~4-18.5 μm per LIFE mission simulations) and may partially overlap MIRI's range, but a specific verified band center for this project's implementation was not established this session; not guessed. |
