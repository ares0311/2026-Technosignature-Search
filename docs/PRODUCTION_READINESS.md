...
| Natural contaminant rejection (dust, debris disk, AGN) | ❌ Not started — the existing `dust_indicator_score`/`galaxy_agn_indicator_score` features in `infrared/prototype.py` remain caller-supplied inputs, not computed from real data. |
