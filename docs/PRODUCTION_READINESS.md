...
| HITRAN cross-section temperature/pressure coverage research request | `docs/hitran_xsc_temperature_pressure_coverage.md` | ⏳ Open — awaiting research agent answer on whether CF4/C2F6/C3F8/SF6/NF3 have HITRAN datasets beyond the single room-temperature/1-atm one already downloaded |
