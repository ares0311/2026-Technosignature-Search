...
step 3 without surviving step 2." An optional freeform LLM "devil's
advocate" critique could layer on top of this deterministic dossier in the
future; it is not required for this step and is out of scope here.
"""
...
ADVERSARIAL_REVIEW_SCHEMA_VERSION = "adversarial_review_v1"
ADVERSARIAL_REVIEW_DISCLAIMER = (
    ...
    "expert review (Step 3) without independent human review of this "
    "dossier (Step 2)."
)
...
def build_adversarial_review_dossier(
    ...
    *,
    ...
    false_positive_probability = float(scores.get("false_positive_probability", 1.0))
