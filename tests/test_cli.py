...
def test_cli_project_status_consistency_summary_outputs_drift_gates() -> None:
    ...
    assert result["decisions_latest_decision"] == 141
...
def test_cli_production_blocker_consistency_summary_outputs_gate_counts() -> None:
    ...
    assert result["ok"] is True
    assert result["actual_tier1_blocker_count"] == 0
    assert result["present_tier1_blockers"] == []
...
def test_cli_validation_summary_outputs_concise_health_dashboard() -> None:
    ...
    assert result["project_status_latest_decision"] == 141
    ...
    assert result["production_blocker_tier1_blocker_count"] == 0
