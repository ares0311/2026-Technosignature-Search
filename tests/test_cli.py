...
def test_cli_project_status_consistency_summary_outputs_drift_gates() -> None:
    ...
    assert result["roadmap_latest_milestone"] == 72
    assert result["decisions_latest_decision"] == 119
    assert result["actual_schema_count"] == 203
...
def test_cli_sqlite_operational_log_adapter_readiness_preflight_outputs_gate() -> None:
    ...
    assert result["schema_count"] == 203
...
def test_cli_sqlite_operational_log_adapter_authorization_gate_outputs_gate() -> None:
    ...
    assert result["readiness_preflight_schema_count"] == 203
    assert result["schema_count"] == 203
...
def test_cli_validation_summary_outputs_concise_health_dashboard() -> None:
    ...
    assert result["project_status_latest_milestone"] == 72
    assert result["project_status_latest_decision"] == 119
    assert result["project_status_schema_count"] == 203
