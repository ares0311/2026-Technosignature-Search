...
def test_json_schema_files_are_parseable_and_named() -> None:
    ...
    assert {path.name for path in schema_paths} == {
        ...
        "system_diagnostics_log.schema.json",
        ...
        "disaster_recovery_log.schema.json",
        "service_level_log.schema.json",
        "asset_management_log.schema.json",
        "network_monitoring_log.schema.json",
        "identity_management_log.schema.json",
        "certificate_management_log.schema.json",
        "alert_escalation_log.schema.json",
        "configuration_change_log.schema.json",
        "contract_management_log.schema.json",
        "data_retention_log.schema.json",
        "knowledge_management_log.schema.json",
        "problem_management_log.schema.json",
        "release_management_log.schema.json",
        "service_request_log.schema.json",
        "supplier_management_log.schema.json",
        "audit_finding_log.schema.json",
        "budget_log.schema.json",
        "training_log.schema.json",
        "change_request_log.schema.json",
        "project_milestone_log.schema.json",
        "vendor_assessment_log.schema.json",
        "communication_log.schema.json",
        "document_management_log.schema.json",
        "procurement_log.schema.json",
    }
